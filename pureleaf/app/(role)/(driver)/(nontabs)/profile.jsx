  ...
  useEffect(() => {
    const loadProfileData = async () => {
      try {
        ...
        // Set form fields from driverData if available, else fallback to userData
        // Format employee_id as DRV-XXXX (4 digits, padded with zeros)
        let employeeId = "";
        if (driverData && driverData.driverId) {
          const idStr = String(driverData.driverId).padStart(4, "0");
          employeeId = `DRV-${idStr}`;
        }
        setFormData({
          name: userData.name || "",
          ...
          emergencyPhoneNumber: driverData.emergencyContact || "",
          licenseExpiryDate: driverData.licenseExpiry || "",
        });

        // Set profile image if available in driverData
        if (driverData && driverData.profileImageUri) {
          setProfileImage({ uri: driverData.profileImageUri });
        }
      } catch {
        ...
        <View style={styles.vehicleCard}>
          ...
          <View style={styles.vehicleDetailsRow}>
            ...
            <View style={{ flex: 1, marginLeft: 18 }}>
              ...
              <Text style={[styles.vehicleLabel, { marginTop: 8 }]}>
                License Plate:
              </Text>
          ...
          <TouchableOpacity
            ...
            onPress={() => setVehicleEditVisible(true)}
          >
            <MaterialIcons name="edit" size={16} color="#4e6c50" />
          ...
          >
            ...
            <View style={styles.labeledInput}>
              ...
              <TextInput
                ...
                keyboardType="phone-pad"
                onChangeText={(text) =>
                  handleChange("emergencyPhoneNumber", text)
                }
              />
            </View>
        ...
        >
          ...
          >
            ...
            <TouchableOpacity
              ...
              onPress={handleVehicleImagePick}
            >
              <Image
                source={vehicleData.image}
                style={styles.vehicleImageEdit}
              />
            ...
            <View style={styles.labeledInput}>
              ...
              <TextInput
                ...
                onChangeText={(text) =>
                  handleVehicleChange("licensePlate", text)
                }
              />
            </View>
            <TouchableOpacity
              style={styles.modalButton}
              onPress={() => setVehicleEditVisible(false)}
            >
              <Text style={styles.modalButtonText}>Save</Text>
            </TouchableOpacity>
          </TouchableOpacity>
