...
import { View, Text, TouchableOpacity, Modal, StyleSheet, ScrollView, Image, ImageBackground, Linking, TextInput } from 'react-native';
  ...
  return (
    <View style={{ flex: 1, backgroundColor: '#f4f8f4' }}>
      <ScrollView contentContainerStyle={{ paddingBottom: 80 }}>
        ...
        {/* Checked In Card */}
        {pageState === 'checkedIn' && !afterFour && (
          <TouchableOpacity style={styles.checkedInCard} onPress={handleEditCheckedIn}>
        ...
        {pageState === 'notCollectingSet' && !afterFour && (
          <TouchableOpacity style={styles.notCollectingCard} onPress={handleEditNotCollecting}>
            <Text style={styles.notCollectingTitle}>I'm not collecting today</Text>
            <Text style={styles.notCollectingReason}>Reason: {notCollectingReason}</Text>
            <Text style={styles.editHint}>Tap to edit</Text>
          </TouchableOpacity>
        )}
        ...
        {afterFour && (
          <>
            <View style={styles.supplierCountCard}>
              <Text style={styles.supplierCountTitle}>Today's Total Suppliers</Text>
              <Text style={styles.supplierCountNum}>
                {suppliers.length} <Text style={styles.supplierCountUnit}>Suppliers</Text>
              </Text>
              ...
              {!readySimulated && (
                ...
                >
                  <Text style={styles.simulateReadyBtnText}>Simulate Ready</Text>
                </TouchableOpacity>
              )}
            </View>
            {/* Start Trip Button */}
        ...
        <View style={styles.modalOverlay}>
          <View style={styles.modalContent}>
            ...
            <View style={styles.modalBtnRow}>
              ...
              <TouchableOpacity style={styles.modalBtnNo} onPress={handleNoCollecting}>
      ...
      >
        <View style={styles.modalOverlay}>
          <View style={styles.modalContent}>
            <Text style={styles.modalTitle}>Why are you not collecting today?</Text>
            <Picker
      ...
      >
        <View style={styles.modalOverlay}>
          <View style={styles.modalContentList}>
            ...
            <TouchableOpacity style={styles.modalBtnNo} onPress={() => setSupplierModalVisible(false)}>
        ...
        <View style={styles.modalOverlay}>
          <View style={styles.profileModalContent}>
            ...
            <View style={styles.profileHeader}>
              <Image source={selectedSupplier?.image} style={styles.profileAvatar} />
              ...
              <View style={styles.profileInfoRow}>
                <View style={styles.profileInfoBlock}>
                  ...
                  <Text style={styles.profileInfoValue}>
                    {selectedSupplier?.bags} <Text style={styles.profileInfoUnit}>Bags</Text>
                  </Text>
                </View>
                <View style={styles.profileInfoBlock}>
                  <Text style={styles.profileInfoLabel}>Fertilizers</Text>
                  <Text style={styles.profileInfoValue}>
                    {selectedSupplier?.fertilizer?.toString().padStart(2, '0')} <Text style={styles.profileInfoUnit}>{selectedSupplier?.fertilizerType}</Text>
                  </Text>
                </View>
              </View>
              <View style={styles.profileAddressRow}>
                <Ionicons name="location-sharp" size={20} color="#183d2b" style={{ marginRight: 8 }} />
                <Text style={styles.profileAddressText}>{selectedSupplier?.address}</Text>
              </View>
              <View style={styles.profileBtnRow}>
                <TouchableOpacity style={styles.modalBtnNo} onPress={handleBackToList}>
