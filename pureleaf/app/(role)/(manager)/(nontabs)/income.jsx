...
const supplyData = [
  { id: '1', date: '2025-07-01', kg: 22, income: 3200, status: 'Delivered', condition: 'Good' },
  { id: '2', date: '2025-07-05', kg: 17, income: 2500, status: 'Pending', condition: 'Coarse' },
  { id: '3', date: '2025-07-10', kg: 10, income: 1600, status: 'Delivered', condition: 'Wet' },
  { id: '4', date: '2025-07-15', kg: 14.5, income: 2100, status: 'Delivered', condition: 'Good' },
  { id: '5', date: '2025-07-20', kg: 18, income: 2800, status: 'Pending', condition: 'Coarse' },
];
...
export default function IncomeScreen() {
  const filteredData = [...supplyData].sort((a, b) => new Date(a.date) - new Date(b.date));
      ...
      <ScrollView horizontal style={{ marginBottom: 100 }}>
        <View style={styles.tableWrapper}>
          <View style={styles.tableHeader}>
            ...
            <Text style={[styles.tableHeaderText, { flex: 1.4 }]}>Income (Rs.)</Text>
            <Text style={[styles.tableHeaderText, { flex: 1.3 }]}>Condition
          ...
          {filteredData.map(item => (
            <View style={styles.tableRow} key={item.id}>
              ...
              <Text style={[styles.tableCell, { flex: 1.4 }]}>Rs. {item.income}</Text>
              <Text style={[styles.tableCell, { flex: 1.3 }]}>{item.condition}</Text>
            </View>
          ))}
        </View>
      </ScrollView>
  ...
  return (
    <SafeAreaView style={{ flex: 1, backgroundColor: '#F4F8F4' }}>
      <ScrollView contentContainerStyle={styles.container}>
        ...
        <Text style={[styles.chartLabel, { marginTop: 24 }]}>Income Trend (Time Plot)</Text>
        <LineChart
...
const styles = StyleSheet.create({
  ...
  title: { fontSize: 28, fontWeight: '800', color: '#274C3C', marginBottom: 20 },
  ...
  summaryValue: { fontSize: 20, fontWeight: 'bold', color: '#1B5E20', marginTop: 4 },

  sectionTitle: { fontSize: 19, fontWeight: '700', color: '#274C3C', marginBottom: 14, marginTop: 30 },
  chartLabel: { fontSize: 16, fontWeight: '600', marginTop: 8, marginBottom: 10, color: '#274C3C' },
